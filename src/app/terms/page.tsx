      ...
      <div className="max-w-4xl mx-auto">
        <div className="page-card">
          ...
          <div className="prose prose-lg max-w-none">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-text-primary mb-4">3. Funcionalidades e Escopos</h2>
              <p className="text-text-secondary mb-4">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-text-primary mb-4">4. Uso Aceitável</h2>
              <p className="text-text-secondary mb-4">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-text-primary mb-4">5. Privacidade e Dados</h2>
              <p className="text-text-secondary mb-4">
                Este aplicativo é projetado para fins educacionais e não armazena dados sensíveis dos usuários. Todas as interações com a API do TikTok são realizadas de forma transparente e segura. Para mais informações sobre como tratamos dados, consulte nossa <a href="/privacy" className="text-accent hover:text-accent-dark underline">Política de Privacidade</a>.
              </p>
            </section>

            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-text-primary mb-4">6. Limitação de Responsabilidade</h2>
              <p className="text-text-secondary mb-4">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-text-primary mb-4">7. Propriedade Intelectual</h2>
              <p className="text-text-secondary mb-4">
            ...
            <section className="mb-8">
              ...
              <p className="text-text-secondary mb-4">
                Se você tiver dúvidas sobre estes Termos de Serviço, entre em contato através do email: <a href="mailto:kontempler@gmail.com" className="text-accent hover:text-accent-dark underline">kontempler@gmail.com</a>
              </p>
            </section>

            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-text-primary mb-4">10. Lei Aplicável</h2>
              <p className="text-text-secondary mb-4">
