        ...
        <div className="page-card">
          ...
          <div className="prose prose-lg max-w-none">
            ...
            <section className="mb-8">
              ...
              <h3 className="text-xl font-semibold text-text-primary mb-3">2.1 Dados do TikTok (Temporários)</h3>
              <p className="text-text-secondary mb-4">
              ...
              <h3 className="text-xl font-semibold text-text-primary mb-3">2.2 Dados Técnicos</h3>
              <p className="text-text-secondary mb-4">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-text-primary mb-4">5. Armazenamento e Segurança</h2>
              <p className="text-text-secondary mb-4">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-text-primary mb-4">6. Cookies e Tecnologias Similares</h2>
              <p className="text-text-secondary mb-4">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-text-primary mb-4">7. Seus Direitos</h2>
              <p className="text-text-secondary mb-4">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-text-primary mb-4">8. Menores de Idade</h2>
              <p className="text-text-secondary mb-4">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-text-primary mb-4">9. Alterações nesta Política</h2>
              <p className="text-text-secondary mb-4">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-text-primary mb-4">10. Contato</h2>
              <p className="text-text-secondary mb-4">
              ...
              <div className="bg-surface-hover p-4 rounded-lg">
                <p className="text-text-secondary">
                  <strong>Email:</strong> <a href="mailto:kontempler@gmail.com" className="text-accent hover:text-accent-dark underline">kontempler@gmail.com</a>
                </p>
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-text-primary mb-4">11. Conformidade Legal</h2>
              <p className="text-text-secondary mb-4">
