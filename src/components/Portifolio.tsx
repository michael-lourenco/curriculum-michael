...
const projectsData: Project[] = [
  {
    ...
    description:
      "Criação de processamento de dados serverless utilizando a GCP e AWS,Criação de novos fluxos através de BPMN e a API do Wordpress. Manutenção e aperfeiçoamento do sistema legado",
    technologies: [
      "AWS",
      "GCP",
      "DynamoDB",
  ...
  },
  {
    ...
    description:
      "Criamos uma integração com o SP-API da Amazon, recebendo dados de uma API externa e enviando para o SP-API da Amazon, através de python utilizando diversos servicos da AWS para uma integração totalmente serverless.",
    technologies: [
      "AWS",
      "API TecAlliance",
      "Python",
  ...
  },
  {
    ...
    description:
      "Desenvolvimento de 11 aplicativos em Realidade Aumentada para eventos individuais da empresa Click-Se",
...

  {
    ...
    description:
      "Desenvolvimento e manutenção do Site da Câmara Municipal de Itapetininga durante 3 anos.",
...

  {
    ...
    description:
      "Aplicativo de Realidade Aumentada para educação científica. Permitia visualizar modelos 3D de formas geométricas em tempo real.",
...

  {
    ...
    image: "/projects/placeholder.jpg",
    description:
      "Guia dos cardápios da cidade de Itapetininga-SP e Região. Exerci atividades de desenvolvedor fullstack, arquitetura de sistemas e demais áreas correlacionadas, pois era o único desenvolvedor. O aplicativo ficou disponível para Android e IOs",
    technologies: ["PHP", "MySQL", "JSON", "Javascript", "HTML", "CSS"],
  ...
  },
  {
    ...
    description:
      "Site da professora, palestrante e minha amada irmã Marianna Lourenço. Graduada em Letras pela PUC-Rio e pós-graduada em Ensino da Língua Inglesa, também atua como mentora em programas de formação de professores promovidos pela Embaixada dos Estados Unidos.",
  ...
  },
  {
    ...
    description:
      "Site da Epe Despachante. Desenvolvimento e manutenção do Site da Epe Despachante durante 2 anos.",
    technologies: ["PHP", "MySQL", "JSON", "Javascript", "HTML", "CSS"],
    status: "completed",
  },
  {
    ...
    description:
      "É um jogo eletrizante que vai exigir noções de lógica, cálculos, agilidade e nervos controlados",
  ...
  },
  {
    ...
    description:
      "Site de publicidade de eventos de Itapetininga/SP e Região. Ficou ativo por 7 anos e virou referencia na região",
